...
$sections = [
    [
        ...
        'markdown' => 'Antes de automatizar, miramos el oficio: qué decisiones importan, qué dolores se repiten y dónde la IA puede devolver capacidad. AlmaDesign ayuda a identificar dónde la IA amplía criterio, tiempo creativo y capacidad de acción humana con trazabilidad, gobernanza y control humano.',
        'extra' => [
            'layout' => 'hero_vertical',
            'background_image' => 'img/cards/consultoria-ia-procesos-hero-v1.webp',
            'image_alt' => 'Personas observando un mapa de procesos conectado, con tecnología y conocimiento al servicio del criterio humano.',
    ...
    [
        ...
        'markdown' => 'No partimos por la herramienta. Partimos por la realidad de la organización. Nuestro enfoque busca ordenar procesos, criterios y decisiones antes de automatizar, para que la inteligencia artificial devuelva espacio para pensar mejor, crear con más tiempo y actuar con sentido humano.',
        'extra' => [
